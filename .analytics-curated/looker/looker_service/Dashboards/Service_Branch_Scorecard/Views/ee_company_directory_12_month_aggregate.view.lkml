view: ee_company_directory_12_month_aggregate {
    ...
    dimension: regrettable_term {
      type: number
      sql: case
        when termination_details.rehireable = 'Yes' then 1 else 0 end;;
    }

    dimension: non_regrettable_term {
      type: number
      sql: case
        when termination_details.rehireable = 'No' then 1 else 0 end;;
    }
