view: t3_purchase_order_details {
  derived_table: {
    sql: SELECT
          ...
          BERP1.INTACCT_DEPARTMENT_ID AS "Requesting_Branch_ID",
          BERP2.INTACCT_DEPARTMENT_ID AS "Deliver_To_Branch_ID",
          ...
          POH.DATE_ARCHIVED,
          POL.ALLOCATION_ID AS "Allocation_ID",
          POL.ALLOCATION_TYPE AS "Allocation_Type"
...
dimension: part_id {
  ...
  dimension: allocation_id {
    description: "Unique id for for PO line item allocation"
    type: number
