view: dim_work_orders_fleet_opt {
  ...
  dimension_group: work_order_billing {
    ...
    convert_tz: no
    datatype: date
    sql: ${TABLE}."WORK_ORDER_BILLING_DATE" ;;
  }
  ...
  dimension_group: work_order_completed_with_nulls {
    type: time
    timeframes: [raw, date, week, month, quarter, year]
    convert_tz: no
    datatype: date
    sql: iff(${TABLE}."WORK_ORDER_COMPLETED_DATE"::DATE = '0001-01-01', null, ${TABLE}."WORK_ORDER_COMPLETED_DATE") ;;
  }
  ...
  dimension_group: work_order_date_archived {
    ...
    convert_tz: no
    datatype: date
    sql: ${TABLE}."WORK_ORDER_DATE_ARCHIVED" ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [work_order_type_name, work_order_billing_type_name, work_order_urgency_level_name, work_order_originator_type_name, work_order_status_name]
  }
}
