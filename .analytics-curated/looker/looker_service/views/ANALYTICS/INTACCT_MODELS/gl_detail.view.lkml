view: gl_detail {
  sql_table_name: "INTACCT_MODELS"."GL_DETAIL" ;;
  drill_fields: [pk_gl_detail_id]
  ...
  dimension: url_journal {
    ...
    html: <a href='{{value}}'target="new" style="color: #0063f3; text-decoration: underline;">{{value}}</a> ;;
  }
  ...
  set: detail {
    fields: [entry_date_date, account_number, journal_title, document, entry_description, amount, debit_credit, url_journal]
  }
