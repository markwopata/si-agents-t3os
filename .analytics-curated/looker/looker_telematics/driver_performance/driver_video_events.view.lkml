...
view: driver_video_events {
  derived_table: {
    sql: SELECT
          ...
          left join analytics.fleetcam.event_types et ON e.event_type_id = et.event_type_id
          ...
          and (es_category <> 'Undefined' OR (es_category = 'Undefined' AND et.event_type_id in (92227,92226,1622,927,926,922)))
          ;;
  }
