view: keypad_controller_types {
  sql_table_name: "ES_WAREHOUSE"."TRACKERS"."KEYPAD_CONTROLLER_TYPES"
    ;;
  ...
  dimension: keypad_controller_name {
    type: string
    sql: ${TABLE}."NAME" ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [keypad_controller_type_id, keypad_controller_name]
  }
}
