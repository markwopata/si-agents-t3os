view: deliveries {
  ...
  dimension_group: completed {
    ...
    sql: ${TABLE}.CAST(${TABLE}."COMPLETED_DATE" AS TIMESTAMP_NTZ) ;;
  }
  ...
  dimension_group: scheduled {
    ...
    sql: ${TABLE}.CAST(${TABLE}."SCHEDULED_DATE" AS TIMESTAMP_NTZ) ;;
  }

  measure: count {
    type: count
    drill_fields: [delivery_id, run_name, contact_name, locations.location_id, locations.nickname]
  }
}
