view: telematics_mothership_hist {
  sql_table_name: "BI_OPS"."TELEMATICS_MOTHERSHIP_HIST" ;;
    ...
    dimension: test_status {
      type: string
      sql:  case when ${secondary_tracker_health_status} = 'HEALTHY' then 'HEALTHY'
              when ${secondary_tracker_health_status} IN ('NEEDS SERVICE ATTENTION','NEEDS TELEMATICS ATTENTION') then 'UNHEALTHY'
              when ${secondary_tracker_health_status} = 'UNSTABLE' then 'UNSTABLE'
              else 'NO STATUS'
              end;;
    }
    ...
    dimension_group: snapshot_date {
      type: time
      description: "This is the date of the historical snapshot"
      timeframes: [raw, time, date, week, month, quarter, year]
    ...
    measure: quick_links {
      ...
      html:
        ...
        <tr>
          <td><a href="https://equipmentshare.looker.com/dashboards/579" target="_blank">Telematics Mothership:</a> </td>
            <td>
            <a href="https://equipmentshare.looker.com/dashboards/579" target="_blank"> ➔</a>
            </td>
            </tr>
            <tr>
        ...
        <td><a href="https://equipmentshare.looker.com/dashboards/861" target="_blank">Telematics Health Scorecard:</a> </td>
        <td>
        <a href="https://equipmentshare.looker.com/dashboards/861" target="_blank"> ➔</a>
        </td>
        </tr>
        <tr>
        <td><hr style="border: 1px solid #DCDCDC; margin: 0;"></td>
