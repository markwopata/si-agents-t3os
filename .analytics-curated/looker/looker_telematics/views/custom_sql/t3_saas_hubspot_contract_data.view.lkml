view: t3_saas_hubspot_contract_data {
  derived_table: {
    sql:
...
select
    *
from
    hubspot_contract_data_adj_looker
...
;;}
  ...
  dimension: MONTHS_REMAINING_ON_CONTRACT {
    type: number
    sql: ${TABLE}.MONTHS_REMAINING_ON_CONTRACT ;;
  }
  ...
  dimension: ACCT_EXEC_HS_ID {
    type: string
    sql: ${TABLE}.ACCT_EXEC_HS_ID ;;
  }

  dimension: ACCT_EXEC_NAME {
    type: string
    sql: ${TABLE}.ACCT_EXEC_NAME ;;
  }
