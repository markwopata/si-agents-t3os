view: t3_saas_billing_sheet_mrr {
  derived_table: {
    sql:
...
-- Looker: billing_sheet_MRR
select
    COMPANY_ID,
    COMPANY_NAME,
    AUTO_BILLING_STATUS,
    CUSTOMER_BILLING_STATUS,
    FK_SHIP_TO_LOCATION_ID,
    CONTRACT_NAME,
    CONTRACT_UNIT_COST,
...
from
  ...
  dimension: FK_SHIP_TO_LOCATION_ID {
    type: string
  ...
  dimension: SUBSCRIPTION_AGREEMENT {
    type: string
    sql: ${TABLE}.SUBSCRIPTION_AGREEMENT ;;
  }
  ...
  dimension: INSTALLED_UNITS {
    type: number
    sql: ${TABLE}.INSTALLED_UNITS ;;
  }

  dimension: BILLING_UNITS {
    type: number
    sql: ${TABLE}.BILLING_UNITS ;;
  }
