...
SELECT askv.asset_id,a.DESCRIPTION AS asset_description, askv.NAME, askv.value/100 as def_level, x.market_name AS serviced_by,
...
and askv.NAME = 'diesel_exhaust_fluid_level'
AND value/100 < .2
                         ;;
  }
