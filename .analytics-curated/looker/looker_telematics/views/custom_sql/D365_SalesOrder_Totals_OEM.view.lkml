view: D365_SalesOrder_Totals_OEM {
...
left join
    ...
    on OEM_totals.D365_CUST_SALES_ORDER_NUMBER = SALESORDER_TO_KITITEMID.D365_CUST_SALES_ORDER_NUMBER
left join
    SO_Kits_Unit
    on OEM_totals.D365_CUST_SALES_ORDER_NUMBER = SO_Kits_Unit.D365_CUST_SALES_ORDER_NUMBER
            ;;
  }
  ...
  dimension: IT_QTY_SUM {
    type: number
    sql: ${TABLE}.IT_QTY_SUM ;;
  }
  ...
  dimension: D365_CUST_INVOICE_ID {
    type: string
    sql: ${TABLE}.D365_CUST_INVOICE_ID ;;
  }
