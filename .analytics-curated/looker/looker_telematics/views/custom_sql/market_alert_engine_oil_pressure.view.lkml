view: market_alert_engine_oil_pressure {
...
SELECT askv.asset_id,a.DESCRIPTION AS asset_description, askv.NAME, askv.value/100 as engine_oil_pressure, x.market_name AS serviced_by,
...
and askv.NAME = 'engine_oil_pressure'
