view: t3_saas_warehouse_shipment_data {
  derived_table: {
    sql:
...
, legacy_tracker_report_warehouse_shipment_data_adj as (
select
    CONCAT(SERIAL_FORMATTED, ' - ', ADJ_CURRENT_COMPANY_ID)::TEXT as DYNAMIC_INDEX,
    LINKED_DEVICE_TYPE as WAREHOUSE_LINKED_DEVICE_TYPE,
    LINKED_DEVICE_TYPE as WAREHOUSE_SHIPPED_PART_DESCRIPTION,
    SERIAL_FORMATTED as SHIPPED_SERIAL_NUMBER,
    SERIAL_FORMATTED as SHIPPED_SERIAL_FORMATTED,
    PHYSICAL_DATE as WAREHOUSE_PHYSICAL_DATE,
    WAREHOUSE_PHYSICAL_DATE_PLUS_60,
    null as INVOICE_LINE_SUM,
    null as INVOICE_SALES_PRICE,
    null as INVOICE_ID,
    null as SALES_ORDER_NUMBER,
    SALES_REF_ID,
    null as COMPANY_NAME_WHS,
    null as HUBSPOT_PIPELINE,
    1 as SERIAL_NUMBER_SHIPPED_INSTANCE,
    null as SECONDARY_SHIPMENT_RECORD,
    CONCAT(SERIAL_FORMATTED, ' - ', ADJ_CURRENT_COMPANY_ID)::TEXT as SN_UNIQUE_IDENTIFIER,
    1 as BILL_BY_SHIPPED_UNIT,
    null as DEVICE_FIRST_ADJUSTMENT_TYPE,
    null as DEVICE_FIRST_ADJUSTMENT_OLD_SERIAL_NUMBER_FORMATTED,
    null as DEVICE_FIRST_ADJUSTMENT_NEW_SERIAL_NUMBER_FORMATTED,
    null as DEVICE_FIRST_ADJUSTMENT_OLD_COMPANY_ID,
    null as DEVICE_FIRST_ADJUSTMENT_NEW_COMPANY_ID,
    SERIAL_FORMATTED as ADJ_CURRENT_SERIAL_FORMATTED,
    COMPANY_ID as ADJ_CURRENT_COMPANY_ID
from
    legacy_tracker_report_not_found_units_potential_billable_units
)

, warehouse_shipment_data_adj_looker as (
select
    *
from
    legacy_tracker_report_warehouse_shipment_data_adj
union
select
    DYNAMIC_INDEX::TEXT as DYNAMIC_INDEX,
    LINKED_DEVICE_TYPE as WAREHOUSE_LINKED_DEVICE_TYPE,
    PART_DESCRIPTION as WAREHOUSE_SHIPPED_PART_DESCRIPTION,
    SHIPPED_SERIAL_FORMATTED as SHIPPED_SERIAL_NUMBER,
    SHIPPED_SERIAL_FORMATTED,
    WAREHOUSE_PHYSICAL_DATE,
    WAREHOUSE_PHYSICAL_DATE_PLUS_60,
    INVOICE_LINE_SUM,
    ...
    HUBSPOT_PIPELINE,
    1 as SERIAL_NUMBER_SHIPPED_INSTANCE,
    SECONDARY_SHIPMENT_RECORD,
    DYNAMIC_INDEX::TEXT as SN_UNIQUE_IDENTIFIER,
    1 as BILL_BY_SHIPPED_UNIT,
    DEVICE_FIRST_ADJUSTMENT_TYPE,
    DEVICE_FIRST_ADJUSTMENT_OLD_SERIAL_NUMBER_FORMATTED,
    DEVICE_FIRST_ADJUSTMENT_NEW_SERIAL_NUMBER_FORMATTED,
    DEVICE_FIRST_ADJUSTMENT_OLD_COMPANY_ID,
    DEVICE_FIRST_ADJUSTMENT_NEW_COMPANY_ID,
    ADJ_CURRENT_SERIAL_FORMATTED,
    ADJ_CURRENT_COMPANY_ID
from
    warehouse_shipment_data_adj
)
...
select
    *
from
    warehouse_shipment_data_adj_looker
  ...
  ;;
    ...
    dimension: WAREHOUSE_SHIPPED_PART_DESCRIPTION {
      type: string
      sql: ${TABLE}.WAREHOUSE_SHIPPED_PART_DESCRIPTION ;;
    }
    ...
    dimension: WAREHOUSE_REQUESTED_SHIP_DATE {
      type: date
      sql: ${TABLE}.WAREHOUSE_PHYSICAL_DATE ;;
    }
  ...
  dimension: DEVICE_FIRST_ADJUSTMENT_TYPE {
    type: string
    sql: ${TABLE}.DEVICE_FIRST_ADJUSTMENT_TYPE ;;
  }

  dimension: DEVICE_FIRST_ADJUSTMENT_OLD_SERIAL_NUMBER_FORMATTED {
    type: string
    sql: ${TABLE}.DEVICE_FIRST_ADJUSTMENT_OLD_SERIAL_NUMBER_FORMATTED ;;
  }

  dimension: DEVICE_FIRST_ADJUSTMENT_NEW_SERIAL_NUMBER_FORMATTED {
    type: string
    sql: ${TABLE}.DEVICE_FIRST_ADJUSTMENT_NEW_SERIAL_NUMBER_FORMATTED ;;
  }

  dimension: DEVICE_FIRST_ADJUSTMENT_OLD_COMPANY_ID {
    type: string
    sql: ${TABLE}.DEVICE_FIRST_ADJUSTMENT_OLD_COMPANY_ID ;;
  }

  dimension: DEVICE_FIRST_ADJUSTMENT_NEW_COMPANY_ID {
    type: string
    sql: ${TABLE}.DEVICE_FIRST_ADJUSTMENT_NEW_COMPANY_ID ;;
  }

  dimension: DEVICE_FIRST_ADJUSTMENT_DATE {
    type:  date
    sql: ${TABLE}.DEVICE_FIRST_ADJUSTMENT_DATE ;;
  }

  dimension: ADJ_CURRENT_SERIAL_FORMATTED {
    type: string
    sql: ${TABLE}.ADJ_CURRENT_SERIAL_FORMATTED ;;
  }
