view: rental_and_retail_join_test_data {
  derived_table: {
    sql:
      (
        select
          ...
          null as is_payable
        from analytics.commission.equipment_sales_finalized_test_data
      ...
      is_payable
      from analytics.commission_dbt.commission_final_all_test_data
