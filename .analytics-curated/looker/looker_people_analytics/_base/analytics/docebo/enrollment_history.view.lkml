view: enrollment_history {
  ...
  dimension: course_date_begin {
    type: date_raw
    sql: ${TABLE}."COURSE_DATE_BEGIN" ;;
  }
  dimension: course_date_end {
    type: date_raw
  ...
  dimension: enrollment_date_begin_validity {
    type: date_raw
    sql: ${TABLE}."ENROLLMENT_DATE_BEGIN_VALIDITY" ;;
  }
  dimension: enrollment_date_complete {
    type: date_raw
    sql: ${TABLE}."ENROLLMENT_DATE_COMPLETE" ;;
  }
  dimension: enrollment_date_expire_validity {
    type: date_raw
    sql: ${TABLE}."ENROLLMENT_DATE_EXPIRE_VALIDITY" ;;
  }
  dimension: enrollment_date_first_access {
    type: date_raw
    sql: ${TABLE}."ENROLLMENT_DATE_FIRST_ACCESS" ;;
  }
  dimension: enrollment_date_inscr {
    type: date_raw
  ...
  dimension: archived_enrollment {
    type: string
    sql: ${TABLE}."ARCHIVED_ENROLLMENT_YES_NO" ;;
  }
}
