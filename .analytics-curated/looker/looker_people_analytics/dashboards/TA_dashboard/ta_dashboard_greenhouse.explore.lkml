...
include: "/_standard/analytics/branch_earnings/market.layer.lkml"
...
explore:  v_fact_application_requisition_offer {
  ...
  join: market {
    ...
    sql_on: try_to_number(${v_dim_office.office_external_id}) = ${market.market_id} ;;
  }

  join: v_fact_application_history {
    type: left_outer
    sql_on: ${v_fact_application_requisition_offer.application_requisition_offer_application_key} = ${v_fact_application_history.application_history_application_key} ;;
    relationship: one_to_many
  }
