...
include: "/_standard/people_analytics/greenhouse/v_fact_engineering_dashboard.view"
...
include: "/_standard/people_analytics/greenhouse/v_fact_recommendation_by_stage.layer.lkml"
include: "/_standard/people_analytics/greenhouse/v_fact_recommendation_pass_through.layer.lkml"




explore: engineering_scorecard {
...
join:  v_dim_office {
  ...
  join: v_fact_engineering_dashboard {
    type: left_outer
    relationship: one_to_one
    sql_on: ${v_dim_application.application_key} = ${v_fact_engineering_dashboard.application_key} ;;
  }

  join: v_fact_recommendation_by_stage{
    type: left_outer
    relationship: one_to_many
    sql_on: ${v_dim_application.application_key} = ${v_fact_recommendation_by_stage.application_key} ;;
  }

  join: recommendation_pass_through{
    type: left_outer
    relationship: one_to_many
    sql_on: ${v_dim_application.application_key} = ${recommendation_pass_through.application_key} ;;
  }
