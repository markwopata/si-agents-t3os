view: payment_applications {
  sql_table_name: "PUBLIC"."PAYMENT_APPLICATIONS"
    ;;
  ...
  dimension: invoice_id {
    ...
    link: {
      label: "Admin"
      url: "https://admin.equipmentshare.com/#/home/transactions/invoices/{{ value }}"
    }
  }
  ...
  dimension: payment_id {
    ...
    link: {
      label: "Admin"
      url: "https://admin.equipmentshare.com/#/home/payments/{{ value }}"
    }
  }
  ...
  measure: count {
    type: count
    drill_fields: [payment_application_id, payments.payment_id, payment_application_erp_refs.count]
  }
}
