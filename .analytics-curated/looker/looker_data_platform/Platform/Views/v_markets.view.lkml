view: v_markets {
  ...
  dimension: market_recordtimestamp {
    type: date
  ...
  measure: count {
    type: count
    drill_fields: [market_name, market_parent_child_market_name, market_parent_child_region_name, market_region_name]
  }
}
