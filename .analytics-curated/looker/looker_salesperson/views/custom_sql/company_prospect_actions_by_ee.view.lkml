view: company_prospect_actions_by_ee {
...
WHERE CREATED_BY = '{{  _user_attributes['email'] }}'
UNION ALL
...
WHERE SALES_REPRESENTATIVE_EMAIL_ADDRESS = '{{  _user_attributes['email'] }}'
  ...
  dimension: link_agg {
    ...
    sql: ${company_name} ;;    html:
      ...
      &nbsp; &nbsp;
       <a href = "https://staging-ba.equipmentshare.com/crm/prospect_note?Prospect%20ID={{ company_prospect_project_id._value | url_encode }}&Company%20Name={{ company_name._value | url_encode }}" target="_blank"><img src="https://icons.iconarchive.com/icons/tatice/cristal-intense/16/Notepad-Bloc-notes-icon.png" width="16" height="16"> Create Note</a>
      &nbsp; &nbsp;
     <a href = "https://equipmentshare.looker.com/dashboards/204?Prospect%20ID={{ company_prospect_project_id._value | url_encode }}&Company%20Name={{ company_name._value | url_encode }}" target="_blank"><img src="https://icons.iconarchive.com/icons/tatice/cristal-intense/16/Notepad-Bloc-notes-icon.png" width="16" height="16">View Notes</a>
      &nbsp; &nbsp;
       <a href = "https://staging-ba.equipmentshare.com/crm/merge_prospect?Prospect%20ID={{ company_prospect_project_id._value | url_encode }}&Company%20Name={{ company_name._value | url_encode }}" target="_blank"><img src="https://icons.iconarchive.com/icons/fatcow/farm-fresh/32/arrow-merge-icon.png" width="16" height="16"> Merge Prospect</a>
      &nbsp; &nbsp;
       <a href = "https://staging-ba.equipmentshare.com/crm/add_project?Company%20Prospect%20ID={{ company_prospect_project_id._value | url_encode }}&Company%20Name={{ company_name._value | url_encode }}" target="_blank"><img src="https://icons.iconarchive.com/icons/awicons/vista-artistic/128/add-icon.png" width="16" height="16"> Assign Prospect to Project</a>
      &nbsp; &nbsp;
      ...
      &nbsp; &nbsp;
      <a href = "https://staging-ba.equipmentshare.com/crm/prospects_quote_templates?Prospect%20ID={{ company_prospect_project_id._value | url_encode }}&Company%20Name={{ company_name._value | url_encode }}" target="_blank"><img src="https://icons.iconarchive.com/icons/papirus-team/papirus-apps/128/github-alonsoenrique-quotes-icon.png" width="16" height="16"> Create Quote</a>
      &nbsp; &nbsp;
      ...
      &nbsp; &nbsp;
      <a href = "https://staging-ba.equipmentshare.com/crm/existing_customer_note?Company%20ID={{ company_prospect_project_id._value | url_encode }}&Company%20Name={{ company_name._value | url_encode }}"  target="_blank"><img src="https://icons.iconarchive.com/icons/tatice/cristal-intense/16/Notepad-Bloc-notes-icon.png" width="16" height="16"> Create Note</a>
      &nbsp; &nbsp;
      ...
      &nbsp; &nbsp;
      <a href = "https://staging-ba.equipmentshare.com/crm/existing_customer_quote_templates?Company%20ID={{ company_prospect_project_id._value | url_encode }}&Company%20Name={{ company_name._value | url_encode }}" target="_blank"><img src="https://icons.iconarchive.com/icons/papirus-team/papirus-apps/128/github-alonsoenrique-quotes-icon.png" width="16" height="16"> Create Quote</a>
      &nbsp; &nbsp;
      <a href = "https://www.google.com/maps/dir/?api=1&destination={{ address._value | url_encode }}+{{ city._value | url_encode }}+{{ state._value | url_encode }}+{{ zipcode._value | url_encode }}&travelmode=car" target="_blank"><img src="https://icons.iconarchive.com/icons/marcus-roberto/google-play/128/Google-Maps-icon.png" width="16" height="16"> Get Directions</a>
      &nbsp; &nbsp;
      ...
      <a href = "https://staging-ba.equipmentshare.com/crm/tasks?Company%20Prospect%20ID={{ company_prospect_project_id._value | url_encode }}&Company%20Name={{ company_name._value | url_encode }}" target="_blank"><img src="https://icons.iconarchive.com/icons/oxygen-icons.org/oxygen/128/Actions-view-calendar-day-icon.png" width="16" height="16"> Create Calendar Event</a>
      &nbsp; &nbsp;
      <a href = "https://staging-ba.equipmentshare.com/crm/lookup_project?Project%20ID={{ company_prospect_project_id._value | url_encode }}&Project%20Name={{ company_name._value | url_encode }}" target="_blank"><img src="https://icons.iconarchive.com/icons/oxygen-icons.org/oxygen/128/Actions-edit-redo-icon.png" width="16" height="16"> Update Project</a>
      &nbsp; &nbsp;
      <a href="{{ folder_url._value }}" target="_blank"><img src="https://icons.iconarchive.com/icons/marcus-roberto/google-play/16/Google-Drive-icon.png" width="16" height="16">Link to Drive Folder</a>
      &nbsp; &nbsp;
      <a href = "https://staging-ba.equipmentshare.com/crm/project_note?Project%20ID={{ company_prospect_project_id._value | url_encode }}&Company%20Name={{ company_name._value | url_encode }}" target="_blank"><img src="https://icons.iconarchive.com/icons/tatice/cristal-intense/16/Notepad-Bloc-notes-icon.png" width="16" height="16"> Create Note</a>
      &nbsp; &nbsp;
     <a href = "https://equipmentshare.looker.com/dashboards/285?Project%20Name={{ company_name._value | url_encode }}" target="_blank"><img src="https://icons.iconarchive.com/icons/tatice/cristal-intense/16/Notepad-Bloc-notes-icon.png" width="16" height="16">View Notes</a>
      &nbsp; &nbsp;
       <a href = "https://staging-ba.equipmentshare.com/crm/lookup_project?Project%20ID={{ company_prospect_project_id._value | url_encode }}&Project%20Name={{ company_name._value | url_encode }}" target="_blank"><img src="https://icons.iconarchive.com/icons/fatcow/farm-fresh/32/arrow-merge-icon.png" width="16" height="16"> Update Project</a>
      &nbsp; &nbsp;
      <a href = "https://staging-ba.equipmentshare.com/crm/reassign_project?Created%20By={{ email._value | url_encode }}&Project%20ID={{ company_prospect_project_id._value | url_encode }}&Project%20Name={{ company_name._value | url_encode }}" target="_blank"><img src="https://icons.iconarchive.com/icons/iconsmind/outline/128/Data-Transfer-icon.png" width="16" height="16"> Reassign Project</a>
      &nbsp; &nbsp;
      <a href = "https://staging-ba.equipmentshare.com/crm/project_quote_templates?Project%20ID={{ company_prospect_project_id._value | url_encode }}&Project%20Name={{ company_name._value | url_encode }}" target="_blank"><img src="https://icons.iconarchive.com/icons/papirus-team/papirus-apps/128/github-alonsoenrique-quotes-icon.png" width="16" height="16"> Create Quote</a>
      &nbsp; &nbsp;
       <a href = "https://www.google.com/maps/dir/?api=1&destination={{ address._value | url_encode }}+{{ city._value | url_encode }}+{{ state._value | url_encode }}+{{ zipcode._value | url_encode }}&travelmode=car" target="_blank"><img src="https://icons.iconarchive.com/icons/marcus-roberto/google-play/128/Google-Maps-icon.png" width="16" height="16"> Get Directions</a>
      &nbsp; &nbsp;
      {% endif %}
