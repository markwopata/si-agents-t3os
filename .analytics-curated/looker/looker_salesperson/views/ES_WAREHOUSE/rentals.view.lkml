view: rentals {
  ...
  measure: rentals_below_floor {
    ...
    html: <u><a href="https://equipmentshare.looker.com/dashboards/238?Asset+ID=&amp;Market={{_filters['market_region_xwalk.market_name'] | url_encode }}&amp;Region={{_filters['market_region_xwalk.region_name'] | url_encode }}&amp;District={{_filters['market_region_xwalk.region_district'] | url_encode }}&amp;Salesperson={{_filters['users.Full_Name_with_ID'] | url_encode }}&amp;Customer=&amp;+Name=&amp;Jobsite+Link=&amp;PO=&amp;Rental+ID=&amp;Asset+Class=&amp;Any+Rate+Below+Floor=Yes&amp;Month+Rate+Below+Floor="target="_blank">{{rendered_value}}</a></u> ;;
  }

  measure: monthly_rentals_below_floor {
    type: count
    filters: [month_below_floor: "Yes"]
    html: <u><a href="https://equipmentshare.looker.com/dashboards/238?Asset+ID=&amp;Market={{_filters['market_region_xwalk.market_name'] | url_encode }}&amp;Region={{_filters['market_region_xwalk.region_name'] | url_encode }}&amp;District={{_filters['market_region_xwalk.region_district'] | url_encode }}&amp;Salesperson={{_filters['users.Full_Name_with_ID'] | url_encode }}&amp;Customer=&amp;Job+Name=&amp;Jobsite+Link=&amp;PO=&amp;Rental+ID=&amp;Asset+Class=&amp;Any+Rate+Below+Floor=&amp;Month+Rate+Below+Floor=Yes"target="_blank">{{rendered_value}}</a></u> ;;
  }
  ...
  measure: market_rentals_below_floor {
    type: count
    filters: [any_below_floor: "Yes"]
    html: <u><a href="https://equipmentshare.looker.com/dashboards/238?Asset+ID=&amp;Market={{_filters['market_region_xwalk.market_name'] | url_encode }}&amp;Region={{_filters['market_region_xwalk.region_name'] | url_encode }}&amp;District={{_filters['market_region_xwalk.region_district'] | url_encode }}&amp;Salesperson=&amp;Customer=&amp;Job+Name=&amp;Jobsite+Link=&amp;PO=&amp;Rental+ID=&amp;Asset+Class=&amp;Any+Rate+Below+Floor=Yes&amp;Month+Rate+Below+Floor="target="_blank">{{rendered_value}}</a></u> ;;
  }
