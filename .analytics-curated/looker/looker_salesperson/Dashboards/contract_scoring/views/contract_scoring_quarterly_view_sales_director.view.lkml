view: contract_scoring_quarterly_view_sales_director {
    derived_table: {
      sql:
...
--         IFF(IS_NULL_VALUE(NULLIFZERO(gross_profit_margin)),null,gross_profit_margin/NULLIFZERO(rr.rental_revenue)) as gross_profit_margin_pct
        ...
        f.parent_company_name_na as parent_company_name,
--         f.Company_name,
        f.sales_director,
--         f.invoice_year,
--         f.Invoice_quarter,
...
--                  where invoice_date = '2024-07-01'
  ...
  dimension: pkey {
    ...
    primary_key: yes
    hidden: yes
    sql: CONCAT(${TABLE}.parent_company_name,${TABLE}.sales_director,${TABLE}.invoice_date)  ;;
  }
