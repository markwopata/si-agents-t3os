view: work_orders {
 sql_table_name: "ES_WAREHOUSE"."WORK_ORDERS"."WORK_ORDERS"
  ...
  measure: total_work_order_inspections_last_month {
    type: count_distinct
    sql: ${work_order_id} ;;
    filters: [work_orders_by_tag.is_inspection: "Yes" ,
      command_audit_wo_completed.close_work_order_command: "Yes",
      command_audit_wo_completed.work_order_is_null: "No",
      command_audit_wo_completed.command_is_last_month: "Yes"]
  }

  measure: count {
    type: count
    drill_fields: [work_order_id, work_order_status_name, work_orders_by_tag.count]
  }
}
