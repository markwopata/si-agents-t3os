view: rentals {
  ...
  dimension: rental_rate_by_customer {
    type: string
    sql: CASE WHEN ${rental_id} is not null THEN 'Past Rental Rates' END ;;
    link: {
      label: "View Rental Rates by Customer"
      url: "https://equipmentshare.looker.com/dashboards/238?Customer={{ _filters['companies.name'] | url_encode }}&toggle=det"
    }
  }
