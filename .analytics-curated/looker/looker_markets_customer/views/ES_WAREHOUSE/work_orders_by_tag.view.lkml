view: work_orders_by_tag {
 sql_table_name: "ES_WAREHOUSE"."WORK_ORDERS"."WORK_ORDERS_BY_TAG"
  ...
  dimension: is_inspection {
    type: yesno
    sql: ${name} = 'Inspection completed' ;;
  }

  dimension: completed_inspection {
    type: yesno
  ...
  measure: count {
    type: count
    drill_fields: [first_name, name, last_name, work_orders.work_order_status_name, work_orders.work_order_id]
  }
}
