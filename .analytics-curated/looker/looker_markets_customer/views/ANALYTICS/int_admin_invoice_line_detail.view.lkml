...
view: int_admin_invoice_line_detail {

  sql_table_name: analytics.intacct_models.int_admin_invoice_line_detail ;;
  ...
  measure: pending_invoices {
    type: count_distinct
    sql: ${invoice_id} ;;
    filters: [is_pending: "yes", is_intercompany: "no", is_deleted: "no"]
  }
