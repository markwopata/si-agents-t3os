    ...
    sql: with qtd_revenue as (
      select
       ...
       from
          ...
          left join ANALYTICS.PUBLIC.v_line_items li on r.rental_id = li.rental_id
          ...
          join ES_WAREHOUSE.PUBLIC.users u on u.user_id = o.salesperson_user_id
          left join market_region_xwalk mr on mr.market_id  = i.ship_from:branch_id
        where
       ...
       group by
          o.salesperson_user_id, u.first_name, u.last_name, mr.market_name
       ),
