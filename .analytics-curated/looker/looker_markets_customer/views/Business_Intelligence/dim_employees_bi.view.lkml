view: dim_employees_bi {
  ...
  dimension: employee_name_html {
    type: string
    group_label: "HTML Employee Name"
    sql: ${TABLE}."NICKNAME";;
    html: <font color="#000000">
          {{rendered_value}}
          <br />
          <font style="color: #8C8C8C; text-align: right;">{{work_email._rendered_value}}</font>
          </font> ;;
