view: company_pulse_first_day_breakdowns_by_market_ttm_district {
  derived_table: {
    sql:
      ...
      from analytics.bi_ops.first_day_breakdowns_by_market_ttm fd
  ...
  dimension: formatted_month {
    ...
    label: "Month"
    type: date
    sql: DATE_TRUNC(month,${delivery_date_date}::DATE) ;;
