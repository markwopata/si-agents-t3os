view: invoices {
  ...
  dimension_group: avalara_transaction_id_update_dt_tm {
    ...
    sql: ${TABLE}.CAST(${TABLE}."AVALARA_TRANSACTION_ID_UPDATE_DT_TM" AS TIMESTAMP_NTZ) ;;
  }
  ...
  dimension_group: due {
    ...
    sql: ${TABLE}.CAST(${TABLE}."DUE_DATE" AS TIMESTAMP_NTZ) ;;
  }
  ...
  dimension_group: invoice {
    ...
    sql: ${TABLE}.CAST(${TABLE}."INVOICE_DATE" AS TIMESTAMP_NTZ) ;;
  }
  ...
  dimension_group: paid {
    ...
    sql: ${TABLE}.CAST(${TABLE}."PAID_DATE" AS TIMESTAMP_NTZ) ;;
  }
  ...
  dimension_group: taxes_invalidated_dt_tm {
    ...
    sql: ${TABLE}.CAST(${TABLE}."TAXES_INVALIDATED_DT_TM" AS TIMESTAMP_NTZ) ;;
  }
