  ...
  derived_table: {
    sql: select
      ...
      from
        ...
        join es_warehouse.public.markets m on a.rental_branch_id = m.market_id
        left join (select asset_id, value as status from es_warehouse.public.asset_status_key_values where name = 'asset_inventory_status') askv on askv.asset_id = a.asset_id
