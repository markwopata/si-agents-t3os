view: tool_trailer_v_asset_rental {
  sql_table_name: "TOOLS_TRAILER"."V_ASSET_RENTAL"
    ;;
  ...
  dimension: notes_combined {
    type: string
    sql: concat(coalesce(${TABLE}."NOTE_OUT", ''), ' ',coalesce(${TABLE}."NOTE_IN", '')) ;;
  }
  ...
  dimension: tool_trailer_asset_rental_id_in {
    type: number
    value_format_name: id
    sql: ${TABLE}."TOOL_TRAILER_ASSET_RENTAL_ID_IN" ;;
  }

  dimension: tool_trailer_asset_rental_id_out {
    type: number
    value_format_name: id
    sql: ${TABLE}."TOOL_TRAILER_ASSET_RENTAL_ID_OUT" ;;
  }
  ...
  set: drill_detail {
    fields: [tool_trailer_asset_rental_id_out, tool_trailer_asset_rental_id_in, asset_id, company_name, start_date, created_by_user_out, created_by_user_in]
  }
