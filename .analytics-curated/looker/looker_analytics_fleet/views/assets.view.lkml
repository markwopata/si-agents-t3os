view: assets {
  ...
  dimension: asset_linked_to_track_w_notification_date {
    ...
    html: <font color="#0063f3"><u><a href="https://app.estrack.com/#/home/assets/all/asset/{{ asset_id._filterable_value }}/history?selectedDate={{ notification_delivery_logs.delivered_date._filterable_value}}" target="_blank">{{value}}</a></font></u>;;
    hidden: yes
  }
  ...
  dimension: asset_linked_to_track_w_speeding_date {
    ...
    type: string
    sql: ${asset_make_model};;
    html: <font color="#0063f3"><u><a href="https://app.estrack.com/#/home/assets/all/asset/{{ asset_id._filterable_value }}/history?selectedDate={{ speed_report_incident_log.start_timestamp_date._filterable_value}}" target="_blank">{{value}}</a></font></u>;;
    hidden: yes
  }
  ...
  measure: asset_count_for_trackers {
    ...
    link: {
      label: "View Trackers by Asset Category"
      url: "{% assign vis= '{\"show_view_names\":false,
      \"show_row_numbers\":true,
      \"transpose\":false,
      \"truncate_text\":true,
  ...
  dimension: asset_custom_name_to_asset_info {
    group_label: "Asset with Link to T3"
    label: "Asset"
    type: string
    sql: ${custom_name};;
    html: <font color="#0063f3"><u><a href="https://app.estrack.com/#/home/assets/all/asset/{{ asset_id._filterable_value }}/status" target="_blank">{{value}}</a></font></u>;;
