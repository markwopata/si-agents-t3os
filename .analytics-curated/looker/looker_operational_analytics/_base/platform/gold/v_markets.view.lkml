view: v_markets {
  ...
  dimension: market_location_city {
    type: string
    sql: ${TABLE}."MARKET_LOCATION_CITY" ;;
  }
  dimension: market_location_description {
    type: string
    sql: ${TABLE}."MARKET_LOCATION_DESCRIPTION" ;;
  }
  dimension: market_location_key {
    type: string
    sql: ${TABLE}."MARKET_LOCATION_KEY" ;;
  }
  dimension: market_location_state_name {
    type: string
    sql: ${TABLE}."MARKET_LOCATION_STATE_NAME" ;;
  }
