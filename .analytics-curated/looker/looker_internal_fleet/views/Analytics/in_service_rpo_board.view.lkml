view: in_service_rpo_board {
  sql_table_name: "ANALYTICS"."MONDAY"."IN_SERVICE_RPO_BOARD" ;;

  dimension: applied_rent {
    type: string
    sql: ${TABLE}."APPLIED_RENT" ;;
  }
  dimension: asset_returned {
    type: yesno
    sql: ${TABLE}."ASSET_RETURNED" ;;
  }
  ...
  dimension_group: rpo_ending {
    type: time
    timeframes: [raw, date, week, month, quarter, year]
    convert_tz: no
    datatype: date
    sql: ${TABLE}."RPO_ENDING_DATE" ;;
  }
  ...
  dimension: total_discounts_2 {
    type: string
    sql: ${TABLE}."TOTAL_DISCOUNTS_2" ;;
  }
