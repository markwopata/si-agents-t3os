view: asset_purchase_history_logs {
  sql_table_name: "PUBLIC"."ASSET_PURCHASE_HISTORY_LOGS"
    ;;
  ...
  dimension: audit_type_id {
    type: number
    sql: ${TABLE}."AUDIT_TYPE_ID" ;;
  }

  dimension: change_list {
    type: string
    sql: ${TABLE}."CHANGE_LIST" ;;
  }
  ...
  dimension_group: date_generated {
    type: time
    timeframes: [
      raw,
      time,
    ...
    sql: CAST(${TABLE}."DATE_GENERATED" AS TIMESTAMP_NTZ) ;;
  }
  ...
  dimension: generated_by_user_id {
    type: number
    sql: ${TABLE}."GENERATED_BY_USER_ID" ;;
  }
  ...
  dimension: purchase_history_log_id {
    type: number
    sql: ${TABLE}."PURCHASE_HISTORY_LOG_ID" ;;
  }
