view: trackers_from_trackers_db {
  ...
  dimension_group: first_report {
    ...
    sql: CAST(${TABLE}."FIRST_REPORT_TIME" AS TIMESTAMP_NTZ) ;;
  }
  ...
  dimension_group: last_config_sync {
    ...
    sql: CAST(${TABLE}."LAST_CONFIG_SYNC_TIME" AS TIMESTAMP_NTZ) ;;
  }
  ...
  dimension_group: last_config_update {
    ...
    sql: CAST(${TABLE}."LAST_CONFIG_UPDATE_TIME" AS TIMESTAMP_NTZ) ;;
  }
