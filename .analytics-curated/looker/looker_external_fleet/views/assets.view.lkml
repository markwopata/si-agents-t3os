view: assets {
  ...
  dimension: asset_linked_to_track_w_notification_date {
    ...
    html: <font color="#0063f3"><u><a href="https://app.estrack.com/#/assets/all/asset/{{ asset_id._filterable_value }}/history?selectedDate={{ notification_delivery_logs.delivered_date._filterable_value}}" target="_blank">{{value}}</a></font></u>;;
  }
