view: tracking_diagnostic_codes {
  ...
  dimension: link_to_diagnostic_codes {
    type: string
    sql: ${asset_id} ;;
    html: <font color="#0063f3"><u><a href="https://app.estrack.com/#/assets/all/asset/{{ asset_id._filterable_value }}/service/diagnostic-codes" target="_blank">Link To Diagnostic Code</a></font></u>;;
  }
  ...
  measure: number_of_codes {
    ...
    drill_fields: [assets.custom_name, assets.make, assets.model, assets.ownership_type, asset_types.asset_types, categories.name, trackers.tracker_information, asset_last_location.location_address, number_of_unique_dtc_codes, link_to_diagnostic_codes, code_groups, failure_mode_identifiers.description_groups, suspect_parameter_numbers.description_groups]
  }
  # description_groups
