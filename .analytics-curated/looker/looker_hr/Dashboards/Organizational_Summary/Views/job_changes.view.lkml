...
SELECT employee_id,
 ...
 ;;}
  ...
  set: detail {
    fields: [employee_id, first_name, last_name, current_title, prior_title,key_ops_jobs_previous, key_ops_jobs_current, effective_date_date, location, market_id, total_count]
  }
