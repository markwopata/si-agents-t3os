  view: companies {
    ...
    dimension: admin_link {
      type: string
      # the last_day_of_month dimension doesn't exist, so I'm editing this in order to be able to push up code. -Jack
      ...
      html: <font color="blue "><u><a href="https://admin.equipmentshare.com/#/home/companies/{{ companies.company_id._value }}" target="_blank">Admin</a></font></u> ;;
      sql: ${company_id}  ;;
    }
