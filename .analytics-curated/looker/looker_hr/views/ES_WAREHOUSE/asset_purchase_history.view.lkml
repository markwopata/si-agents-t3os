view: asset_purchase_history {
  ...
  set: fleet_details {
    fields: [assets.company_id, finance_status,financial_schedule_id,order_number_fleet,asset_id,assets.asset_class,assets.year,assets.make,assets.model,assets.serial_number_vin,invoice_number_fleet,assets.market_id_to_use,markets.market_name, assets.factory_build_specs,
      total_purchase_price,assets.purchase_created_date,net_terms_finance_status_vendor.due_date,net_terms_finance_status_vendor.days_until_due,purchase_order_number,pending_schedule, aph_vendor.vendor_id, aph_vendor.vendor_name,aph_vendor.reconciliation_status,
      aph_vendor.order_status,abl_category.abl_category]
  }
}
