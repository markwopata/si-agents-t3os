view: asset_physical {
  ...
  dimension: asset_market {
    type: number
    sql: COALESCE(${rental_branch_id}, ${service_branch_id}, ${inventory_branch_id}) ;;
  }

  measure: count {
    type: count
    drill_fields: [custom_name, equip_class_name, parent_category_name, sub_category_name, equip_model_name]
  }
}
