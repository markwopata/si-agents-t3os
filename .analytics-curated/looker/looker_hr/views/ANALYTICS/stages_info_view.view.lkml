view: stages_info_view {
  ...
  measure: offer_average {
    type: average
    sql: ${offer_time};;
    value_format: "0.##"
    drill_fields: [application_info_view.candidate_name, application_info_view.application_stage, offer_time]
  }
  ...
  measure: manager_phone_screen_average {
    ...
    value_format: "0.##"
    drill_fields: [application_info_view.candidate_name, application_info_view.application_stage, manager_phone_screen_time]
  }

  measure: HR_phone_screen_average {
    type: average
    sql: ${hr_phone_screen_time};;
    value_format: "0.##"
    drill_fields: [application_info_view.candidate_name, application_info_view.application_stage, hr_phone_screen_time]
  }

  measure: face_to_face_average {
    type: average
    sql: ${face_to_face_time};;
    value_format: "0.##"
    drill_fields: [application_info_view.candidate_name, application_info_view.application_stage, face_to_face_time]
  }

  measure: disc_average {
    type: average
    sql: ${disc_time};;
    value_format: "0.##"
    drill_fields: [application_info_view.candidate_name, application_info_view.application_stage, disc_time]
  }

  measure: application_review_average {
    type: average
    sql: ${application_review_time};;
    value_format: "0.##"
    drill_fields: [application_info_view.candidate_name, application_info_view.application_stage, application_review_time]
  }
}
