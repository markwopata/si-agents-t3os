view: v_cx_conversations_with_emails {
  sql_table_name: "PEOPLE_ANALYTICS"."BUSINESS_INTELLIGENCE"."V_CX_CONVERSATIONS_WITH_EMAILS" ;;
  ...
  measure: count {
    type: count
    drill_fields: [teammate_first_name, inbox_name, teammate_last_name]
  }
}
