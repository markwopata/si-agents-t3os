view: purchase_order_headers_mby {
  derived_table: {
    sql:
      with prodbom_stg as (
      ...
      , purchase_order_headers_mby_mart as (
      select
      purchase_order_headers_mby_int.PO_NUMBER,
      purchase_order_headers_mby_int.REQUESTED_RECEIPT_DATE,
      purchase_order_headers_mby_int.SITE,
      purchase_order_headers_mby_int.DOCUMENT_STATE,
      purchase_order_headers_mby_int.PURCHASE_ORDER_STATUS,
      purchase_order_headers_mby_int.VENDOR_GROUP,
      purchase_order_headers_mby_int.VENDOR_ACCOUNT,
      purchase_order_headers_mby_int.VENDOR_NAME,
      purchase_order_headers_mby_int.REFERENCE_TYPE,
      purchase_order_headers_mby_int.REFERENCE_NUMBER,
      sum_purchase_order_lines_mby_int.SUM_NET_AMOUNT::DECIMAL(15,2) as SUM_NET_AMOUNT,
      purchase_order_headers_mby_int.ORDERER
      from
      purchase_order_headers_mby_int
      left join
      sum_purchase_order_lines_mby_int
      on purchase_order_headers_mby_int.PO_NUMBER = sum_purchase_order_lines_mby_int.PO_NUMBER
      order by
      PO_NUMBER
      )

      select * from purchase_order_headers_mby_mart
      ;;
    }
  ...
  dimension: REQUESTED_RECEIPT_DATE {
    type: date
    sql: ${TABLE}.REQUESTED_RECEIPT_DATE ;;
  }
  ...
  dimension: DOCUMENT_STATE {
    type: string
    sql: ${TABLE}.DOCUMENT_STATE ;;
  }
  ...
  dimension: VENDOR_GROUP {
    type: string
    sql: ${TABLE}.VENDOR_GROUP ;;
  }

  dimension: VENDOR_ACCOUNT {
    type: string
    sql: ${TABLE}.VENDOR_ACCOUNT ;;
  }
  ...
  dimension: SUM_NET_AMOUNT {
    type: number
    sql: ${TABLE}.SUM_NET_AMOUNT ;;
  }
