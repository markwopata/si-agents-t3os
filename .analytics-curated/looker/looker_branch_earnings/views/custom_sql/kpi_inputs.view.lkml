view: kpi_inputs {
  ...
  dimension: oec {
    ...
    link: {
      label: "Detail View"
      url: "@{db_oec_detail}?Period={{ _filters['plexi_periods.display'] | url_encode }}&Market+Name={{ _filters['mkt_name'] | url_encode }}&Region+Name={{ _filters['market_region_xwalk.region_name'] | url_encode }}&Region+District={{ _filters['market_region_xwalk.region_district'] | url_encode }}&Market+Type={{ _filters['market_region_xwalk.market_type'] | url_encode }}&Market+Greater+Than+12+Months+Open%3F+%28Yes+%2F+No%29={{ _filters['kpi_inputs.greater_twelve_months_open'] | url_encode }}&toggle=det"
    }
    sql: ${TABLE}."OEC" ;;
  }
