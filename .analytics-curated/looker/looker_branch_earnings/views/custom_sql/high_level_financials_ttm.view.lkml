view: high_level_financials_ttm {
  derived_table: {
    sql:
      select
  ...
  dimension: market_name {
    ...
    link: {
      ...
      url: "@{db_how_do_i_improve}?Period={{ _filters['high_level_financials_ttm.period_name'] | url_encode }}&Market+Name={{ filterable_value }}&toggle=det"
    }
    link: {
      label: "Branch Earnings Dashboard"
      url: "@{db_branch_earnings_dashboard}?Period={{ _filters['high_level_financials_ttm.period_name'] | url_encode }}&Market+Name={{ filterable_value }}&Markets+Greater+Than+12+Months+Open={{ _filters['revmodel_market_rollout_conservative.greater_twelve_months_open'] | url_encode }}&toggle=det"
    }
    link: {
  ...
  dimension: district {
    ...
    link: {
      label: "How Do I Improve?"
      url: "@{db_how_do_i_improve}?Period={{ _filters['high_level_financials_ttm.period_name'] | url_encode }}&Region+District={{ filterable_value }}&Markets+Greater+Than+12+Months+Open={{ _filters['revmodel_market_rollout_conservative.greater_twelve_months_open'] | url_encode }}&Market+Type={{ _filters['market_region_xwalk.market_type'] | url_encode }}&toggle=det"
    }
    link: {
      label: "Branch Earnings Dashboard"
      url: "@{db_branch_earnings_dashboard}?Period={{ _filters['high_level_financials_ttm.period_name'] | url_encode }}&District+Number={{ filterable_value }}&Markets+Greater+Than+12+Months+Open={{ _filters['revmodel_market_rollout_conservative.greater_twelve_months_open'] | url_encode }}&toggle=det"
    }
    link: {
      label: "Market Dashboard"
    ...
    link: {
      label: "Market Headcount Allocation"
      url: "@{db_market_headcount_allocation}?District+ID={{ filterable_value }}&Markets+Greater+Than+12+Months+Open={{ _filters['high_level_financials_ttm.months_open_greater_than_twelve'] | url_encode }}&toggle=det"
    }
    link: {
      label: "Executive Summary"
      url: "@{db_executive_summary}?District={{ filterable_value }}&Markets+Greater+Than+12+Months+Open={{ _filters['high_level_financials_ttm.months_open_greater_than_twelve'] | url_encode }}&Region+Granularity=market&toggle=det"
    }
  }
  ...
  dimension: region_name {
    ...
    link: {
      label: "How Do I Improve?"
      url: "@{db_how_do_i_improve}?Period={{ _filters['high_level_financials_ttm.period_name'] | url_encode }}&Region+Name={{ filterable_value }}&&Market+Type={{ _filters['market_region_xwalk.market_type'] | url_encode }}&Markets+Greater+Than+12+Months+Open={{ _filters['revmodel_market_rollout_conservative.greater_twelve_months_open'] | url_encode }}&toggle=det"
    }
    link: {
      label: "Branch Earnings Dashboard"
      url: "@{db_branch_earnings_dashboard}?Period={{ _filters['high_level_financials_ttm.period_name'] | url_encode }}&Region+Name={{ filterable_value }}&Markets+Greater+Than+12+Months+Open={{ _filters['revmodel_market_rollout_conservative.greater_twelve_months_open'] | url_encode }}&toggle=det"
    }
    link: {
      label: "Market Dashboard"
    ...
    link: {
      label: "Market Headcount Allocation"
      url: "@{db_market_headcount_allocation}?Region+Name={{ filterable_value }}&Markets+Greater+Than+12+Months+Open={{ _filters['high_level_financials_ttm.months_open_greater_than_twelve'] | url_encode }}&toggle=det"
    }
  }
  ...
  measure: most_recent_selected_period_oec {
    ...
    {% if _filters['high_level_financials_ttm.market_name'] %}
      {% assign market_name_param = _filters['high_level_financials_ttm.market_name'] | url_encode %}
    {% elsif high_level_financials_ttm.market_name._filterable_value and high_level_financials_ttm.market_name._filterable_value != "NULL" %}
      {% assign market_name_param = high_level_financials_ttm.market_name._filterable_value | url_encode %}
    {% endif %}

      {% assign district_param = '' %}
      {% if _filters['high_level_financials_ttm.district']%}
      {% assign district_param = _filters['high_level_financials_ttm.district'] | url_encode %}
      {% elsif high_level_financials_ttm.district._filterable_value and high_level_financials_ttm.district._filterable_value != "NULL" %}
      {% assign district_param = high_level_financials_ttm.district._filterable_value | url_encode %}
      {% endif %}
      ...
      <u><a href="@{db_oec_detail}?Region+Name={{ region_name_param }}&Period={{ _filters['high_level_financials_ttm.period_name'] | url_encode }}&Market+Name={{ market_name_param }}&District+Number={{ district_param }}&Market+Type={{ mkt_type_param }}&toggle=det" target="_blank">{{ linked_value }}</a></u>
      ;;
  }
