view: stg_es_warehouse_public__orders {
  sql_table_name: "INTACCT_MODELS"."STG_ES_WAREHOUSE_PUBLIC__ORDERS" ;;
  ...
  dimension: is_crm_enabled {
    type: yesno
    sql: ${TABLE}."IS_CRM_ENABLED" ;;
  }
  dimension: is_deleted {
    type: yesno
    sql: ${TABLE}."IS_DELETED" ;;
  }
  dimension: is_delivery_required {
    type: yesno
    sql: ${TABLE}."IS_DELIVERY_REQUIRED" ;;
  }
  dimension: is_insurance_covers_rental {
    type: yesno
    sql: ${TABLE}."IS_INSURANCE_COVERS_RENTAL" ;;
  }
  dimension: job_id {
    type: number
    sql: ${TABLE}."JOB_ID" ;;
