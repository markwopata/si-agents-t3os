view: dim_markets {
  ...
  dimension: market_district_html {
    type: string
    sql: ${TABLE}."MARKET_NAME" ;;
    html: <font color="#000000">
          {{rendered_value}}
          <br />
          <font style="color: #8C8C8C; text-align: right;">District {{market_district._rendered_value}}</font>
          </font> ;;
  }
  ...
  dimension: market_region_name_combo {
    type: string
    sql: ${TABLE}."MARKET_REGION" || ' ' || ${TABLE}."MARKET_REGION_NAME" ;;
  }
  ...
  dimension: location {
    type: string
    label_from_parameter: location_filter
    sql:
    {% if location_filter._parameter_value == 'region' %}
      ${market_region_name}
    {% elsif location_filter._parameter_value == 'district' %}
      ${market_district}
    {% else %}
      ${market_name}
    {% endif %}
