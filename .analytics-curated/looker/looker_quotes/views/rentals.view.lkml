view: rentals {
  ...
  measure: count {
    type: count
    drill_fields: [parent_rental_id, inventory_product_name, rentals.inventory_product_name, rentals.parent_rental_id, rentals.count]
  }
}
