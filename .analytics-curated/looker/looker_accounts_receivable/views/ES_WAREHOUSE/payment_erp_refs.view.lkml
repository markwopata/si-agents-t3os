view: payment_erp_refs {
  sql_table_name: "ES_WAREHOUSE"."PUBLIC"."PAYMENT_ERP_REFS"
    ;;
  drill_fields: [payment_erp_ref_id]

  dimension: payment_erp_ref_id {
    primary_key: yes
    type: number
    sql: ${TABLE}."PAYMENT_ERP_REF_ID" ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [payment_erp_ref_id, payments.payment_id]
  }
}
