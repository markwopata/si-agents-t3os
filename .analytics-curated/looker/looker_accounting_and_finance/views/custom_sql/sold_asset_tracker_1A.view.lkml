view: sold_asset_tracker_1a {
  derived_table: {
    ...
    where (b.PAID = 'false' or b.PAID is null)
      and a.LINE_ITEM_TYPE_ID in (24,50,81)
      and (c.FINANCIAL_SCHEDULE_ID not in (2097,1539,1357,1359,2770,2769,2399,1615,1391)
            or c.FINANCIAL_SCHEDULE_ID is null)
      --and (d.COMPANY_ID <> 1854 or d.COMPANY_ID is null)
    and (e.CREDIT_NOTE_LINE_ITEM_ID is null or e.CREDIT_AMOUNT < a.AMOUNT)
)
