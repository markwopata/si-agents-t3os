view: cash_inflow_outflow_level_two_tags {
  derived_table: {
...
where  io.DATE::date between dateadd(day, -6, {% date_start date_filter %}) and dateadd(day, 0, {% date_start date_filter %})
...
where lt.DATE::date between dateadd(day, -6, {% date_start date_filter %}) and dateadd(day, 0, {% date_start date_filter %})
