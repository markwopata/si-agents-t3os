view: apa__bills_posted_in_prior_period_to_por_accrual {
  sql_table_name: "ACCRUAL_GOLD"."APA__BILLS_POSTED_IN_PRIOR_PERIOD_TO_POR_ACCRUAL" ;;
  ...
  dimension: is_bill_posted_before_receipt {
    type: yesno
    sql: ${TABLE}."IS_BILL_POSTED_BEFORE_RECEIPT" ;;
  }
  dimension: is_bill_posted_in_prior_month_to_receipt {
    type: yesno
    sql: ${TABLE}."IS_BILL_POSTED_IN_PRIOR_MONTH_TO_RECEIPT" ;;
  }
  dimension: is_no_receipt_accrual_found {
    type: yesno
    sql: ${TABLE}."IS_NO_RECEIPT_ACCRUAL_FOUND" ;;
  }
  dimension: journal {
    type: string
    sql: ${TABLE}."JOURNAL" ;;
