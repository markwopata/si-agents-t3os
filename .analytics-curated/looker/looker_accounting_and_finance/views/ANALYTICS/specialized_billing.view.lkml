view: specialized_billing {
  sql_table_name: "ANALYTICS"."TREASURY"."SPECIALIZED_BILLING" ;;
...
######## DIMENSIONS ########
  ...
  dimension: customer_name {
    type: string
    html: <a href= "https://admin.equipmentshare.com/#/home/companies/{{ specialized_billing.customer_id }}" target="_blank" style="color: #0063f3; text-decoration: underline;">{{ value }}</a> ;;
