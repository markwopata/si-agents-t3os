view: asset_utilization_by_day {
  ...
  measure: total_run_time_date_range {
    ...
    type: sum
    sql: ${run_time} ;;
    html: <a href="#drillmenu" target="_self">{{total_run_time_no_icon._rendered_value}} <img src="https://imgur.com/ZCNurvk.png" height="15" width="15"></a>;;
    # drill_fields: [run_time_detail*]
    value_format_name: decimal_1
    link: {
      label: "View Run Time for Asset"
  ...
  measure: total_idle_time_date_range {
    ...
    type: sum
    sql: ${idle_time} ;;
    html: <a href="#drillmenu" target="_self"> {{total_idle_time_no_icon._rendered_value}} <img src="https://imgur.com/ZCNurvk.png" height="15" width="15"></a> ;;
    # drill_fields: [idle_time_detail*]
    value_format_name: decimal_1
    link: {
      label: "View Idle Time for Asset"
  ...
  measure: total_on_time_date_range {
    ...
    type: sum
    sql: ${on_time} ;;
    html: <a href="#drillmenu" target="_self">{{total_on_time._rendered_value}} <img src="https://imgur.com/ZCNurvk.png" height="15" width="15"></a>;;
    # drill_fields: [on_time_detail*]
    value_format_name: decimal_1
    link: {
      label: "View On Time for Asset"
