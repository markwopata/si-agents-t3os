view: stage_clustdoc_vendor_app_checks {
  sql_table_name: "VENDORS_GOLD"."CLUSTDOC_VENDOR_APP_CHECKS" ;;
  ...
  dimension_group: timestamp_client_modified {
    ...
    sql: ${TABLE}."TIMESTAMP_CLIENT_MODIFIED" ;;
  }
  dimension_group: timestamp_closed {
    type: time
    timeframes: [raw, time, date, week, month, quarter, year]
    sql: ${TABLE}."TIMESTAMP_CLOSED" ;;
  }
  ...
  dimension_group: timestamp_last_updated_clustdoc {
    type: time
    timeframes: [raw, time, date, week, month, quarter, year]
    sql: ${TABLE}."TIMESTAMP_LAST_UPDATED_CLUSTDOC" ;;
  }
  dimension_group: timestamp_latest_linked_app_sage {
    type: time
    timeframes: [raw, time, date, week, month, quarter, year]
    sql: ${TABLE}."TIMESTAMP_LATEST_LINKED_APP_SAGE" ;;
  }
  ...
  dimension_group: timestamp_submitted {
    type: time
    timeframes: [raw, time, date, week, month, quarter, year]
    sql: ${TABLE}."TIMESTAMP_SUBMITTED" ;;
  }
  dimension_group: timestamp_terms_accepted {
    type: time
    timeframes: [raw, time, date, week, month, quarter, year]
    sql: ${TABLE}."TIMESTAMP_TERMS_ACCEPTED" ;;
  }
