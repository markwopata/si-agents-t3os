view: p2p_sage_payables_1307_with_gs_vendors_bob {derived_table: {
    sql:


      with sage_vendors as (SELECT
...
select  sv.*, gs.book_of_business, financing_designation
from sage_vendors sv
left join analytics.fleet.gs_fleet_vendor_list gs
on sv.vendorid = gs.sage_vendor_id
...
# }
  ...
  set: drill_detail {
    fields: [
      ...
      account,
      account_name,
      amount, submit_date_time,item_id
    ]
  }
