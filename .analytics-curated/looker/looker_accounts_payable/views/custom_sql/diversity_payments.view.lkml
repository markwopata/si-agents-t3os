...
#}
  ...
  dimension: amount { type: number sql: ${TABLE}.amount ;; }
    measure: sum_amount {
      type: sum
      ##value_format: "$#,##0;($#,##0);-"
      drill_fields: [account,account_name,vendor_id,vendor_name,vendor_type,diversity_classification, vendor_category, sum_amount, payment_date,payment_type, asset_id,invoice_number,po_number,
        departmentid,department_type,state_id,department_title]
    ...
    # measure: run_rate_2025 {
    #   label: "2025 Run Rate"
    #   value_format_name: usd_0
    #   type: sum
    #   sql: (${TABLE}."AMOUNT"/(datediff(day,'2024-12-31',current_date)))*365 ;;
    #   filters: [submit_date_date: "this year",
    #     is_current_week: "no"]
    # }

    # measure: run_rate_qtr {
    #   label: "Q4'25 Run Rate"
    #   value_format_name: usd_0
    #   type: sum
    #   sql: (${TABLE}."AMOUNT"/(datediff(day,'2025-09-30',current_date)))*92 ;;
    #   filters: [submit_date_date: "this quarter",
    #     is_current_week: "no"]
    # }
    ...
    set: drill_detail {
      fields: [
        ...
        account,
        account_name,
        amount, submit_date_time, today_date, weeks_in_prior_month, current_week_of_year,related_parties,item_id
      ]
    }
