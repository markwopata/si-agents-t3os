view: sage_access_24hr_role_delta {
  derived_table: {
    sql: --Detection of a New Role being created or the alteration of an existing Role
      ...
      FROM "ANALYTICS"."INTACCT"."ROLES" as CR

      LEFT JOIN (select NAME AS "PRIOR_NAME", RECORDNO from "ANALYTICS"."INTACCT"."ROLES" at (offset => -60*60*24)) AS PR
