view: asset_purchase_history {
  ...
  measure: count {
    type: count
    drill_fields: [assets.custom_name, assets.asset_id, assets.name, assets.driver_name]
  }
  ...
  set: fleet_details {
    fields: [finance_status,financial_schedule_id,order_number_fleet,asset_id,assets.asset_class,assets.year,assets.make,assets.model,assets.serial_number_vin,invoice_number_fleet,markets.location, assets.factory_build_specs,
      total_purchase_price,assets.purchase_created_date,net_terms_finance_status.due_date,net_terms_finance_status.days_until_due,purchase_order_number,pending_schedule, aph_vendor.vendor_id, aph_vendor.vendor_name]
  }
}
