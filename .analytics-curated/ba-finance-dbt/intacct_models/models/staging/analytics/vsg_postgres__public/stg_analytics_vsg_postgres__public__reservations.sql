select
    ...
    r.return_at,
    r.pickup_at,
    convert_timezone(pickup_timezone, pickup_at) as pickup_at_local_tz, -- pickup_at is in UTC. This converts it to the local time zone of the pickup location for when reservations are "actually" picked up.
